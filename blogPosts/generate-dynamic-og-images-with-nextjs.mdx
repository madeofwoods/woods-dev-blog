...
<Img alt="alt" src="/blogs/generateOG/og3.png" />
...
From this I can now dynamically add any text to the image. I could also add unique colour codes, image URLs and more.
