...
The <Tag>api</Tag> documentation is written for the pages directory. So, although I did find an example of a dediecated <Tag>api</Tag> being used within the page folder of the app directory, I decided to pass on that one.
