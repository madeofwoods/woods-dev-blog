...
The next step is to prepare the custom components to be passed to MDXRemote. I can create custom components for simple HTML tags like <Tag>`<h1>`</Tag> and <Tag>`<strong>`</Tag>.
...
This component object can then be passed to the MDXRemote component as a prop.
...
I will probably write separate posts for these features.
